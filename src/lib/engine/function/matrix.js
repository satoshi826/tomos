...
export const mat = {
  ...
  texMap(dest) {
    dest[0] = 0.5; dest[1] = 0; dest[2] = 0; dest[3] = 0
    dest[4] = 0; dest[5] = 0.5; dest[6] = 0; dest[7] = 0
    dest[8] = 0; dest[9] = 0; dest[10] = 1; dest[11] = 0
    dest[12] = 0.5; dest[13] = 0.5; dest[14] = 0; dest[15] = 1
    return dest
  },
  ...
  mulVec(mat1, vec, dest) {
    const x = vec[0]
    const y = vec[1]
    const z = vec[2]
    dest[0] = x * mat1[0] + y * mat1[4] + z * mat1[8] + mat1[12]
    dest[1] = x * mat1[1] + y * mat1[5] + z * mat1[9] + mat1[13]
    dest[2] = x * mat1[2] + y * mat1[6] + z * mat1[10] + mat1[14]
    dest[3] = x * mat1[3] + y * mat1[7] + z * mat1[11] + mat1[15]
    let w = dest[3]
    if (w !== 1.0) {
      dest[0] /= w
      dest[1] /= w
  ...
  look(eye, center, up, dest) {
    let eyeX = eye[0], eyeY = eye[1], eyeZ = eye[2],
      upX = up[0], upY = up[1], upZ = up[2],
      centerX = center[0], centerY = center[1], centerZ = center[2]
    if(eyeX === centerX && eyeY === centerY && eyeZ === centerZ) {
      return this.reset(dest)
    }
  ...
  pers(fovy, aspect, near, far, dest) {
