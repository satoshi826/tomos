...
import {CanvasSize, DEFAULT_POSITION, Message, Position, ScreenPosition, Topic} from './type'
...
const defaultMessage = range(10).map(x => range(10).map(y => ({id: 'message', x, y, userId: 'user', text: `message ${x}_${y}`, createdAt: '20241101'}))).flat()
