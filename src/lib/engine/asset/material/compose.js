...
export const compose = () => ({
  ...
  void main(void){
    ...
    vec3 outputC = dofPowerNormal * toneMapBlur + (1.0 - dofPowerNormal) * outputBase;

    o_color = vec4(outputDof, 1.0);
    // o_color = vec4(vec3(dofPower), 1.0);
