...
export function useDragCallback({ callback, ref }: { callback: Callback; ref: CanvasWrapperRef }) {
  ...
  const drag = (clientX: number, clientY: number) => {
    ...
    const shortSide = Math.min(ref.current.clientWidth, ref.current.clientHeight)
  ...
  const handleMouseDown = ({ clientX, clientY }: MouseEvent) => tapStart(clientX, clientY)
