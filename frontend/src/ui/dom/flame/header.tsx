...
export function Header({ toggleOpen }: { toggleOpen: () => void }) {
  return (
    <div className="z-20 flex items-center justify-between border-divider-extension border-b bg-base-100 px-3 py-2 shadow-xl backdrop-blur-lg backdrop-saturate-200">
